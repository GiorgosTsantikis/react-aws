...
public class CustomerController {
    ...
    public ResponseEntity<byte[]> uploadCustomerProfileImage(
            @PathVariable("customerId") Integer customerId) {
     return   ResponseEntity.ok().contentType(MediaType.IMAGE_PNG).body(customerService.getCustomerProfileImage(customerId));
    }
